...
class UserAction(models.Model):
    ...
    ACTION_TYPES = [
        ...
        ('playlist_make_collaborative', 'Make Collaborative'),
        ('track_add', 'Add Track'),
        ...
        ('liked_songs_add', 'Add to Liked Songs'),
        ('liked_songs_remove', 'Remove from Liked Songs'),
        ('comment_add', 'Add Comment'),
        ('comment_edit', 'Edit Comment'),
        ('comment_delete', 'Delete Comment'),
        ('comment_reply', 'Reply to Comment'),
        ('comment_like', 'Like Comment'),
        ('comment_remove_like', 'Remove Like from Comment'),
